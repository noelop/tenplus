...
GameOver.prototype = {
  ...
  create: function () {
     if (gameOptions.music_curren !== "francis" && gameOptions.playMusic !== false) {
            music_bongo.stop();
            gameOptions.music_curren = music_francis.name;
            music_francis.play();
        }
    console.log('game:',GameOver.Score)
    ...
    var scoreText = this.addTextOption("Score = "+GameOver.Score, w / 2 , 210, null, 60, 'Impact');
